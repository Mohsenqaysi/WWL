...
var Model02: [GameModel] = [
    GameModel(key: "k_a", CounterProperty: [CounterProperty(color: 1, counterChanged: true), CounterProperty(color: 2, counterChanged: true),CounterProperty(color: 1, counterChanged: false)]),
